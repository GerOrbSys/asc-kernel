...
#if defined(CONFIG_SOC_CAMERA_TAU640) || defined(CONFIG_SOC_CAMERA_TAU640_MODULE)
/* Input available at the tau640 */
static struct v4l2_input tau640_inputs[] = {
	{
		.index = 0,
		.name = "Camera",
		.type = V4L2_INPUT_TYPE_CAMERA,
...
#if defined(CONFIG_SOC_CAMERA_MT9J003) || defined(CONFIG_SOC_CAMERA_MT9J003_MODULE)
...
static struct vpfe_subdev_info vpfe_sub_devs[] = {
...
#if defined(CONFIG_SOC_CAMERA_TAU640) || defined(CONFIG_SOC_CAMERA_TAU640_MODULE)
	{
		.module_name = "tau640",
		.is_camera = 1,
		.grp_id = VPFE_SUBDEV_TAU640,
		.num_inputs = ARRAY_SIZE(tau640_inputs),
		.inputs = mt9j003_inputs,
		.ccdc_if_params = {
			.if_type = VPFE_RAW_BAYER,  // TODO: maybe change needed
			.hdpol = VPFE_PINPOL_POSITIVE,
			.vdpol = VPFE_PINPOL_POSITIVE
		},
		.board_info = {
			I2C_BOARD_INFO("tau640", 0x48),
			.platform_data = (void *)1,
		},
	}
#endif
